...
use covariance for methods which return a generic type use contra-variance for methods which take a generic type use in-variance for methods which both accept and return a generic type
